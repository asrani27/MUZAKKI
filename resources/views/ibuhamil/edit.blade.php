...
<form class="form-horizontal" action="{{route('editibuhamil', $data->id)}}" method="POST">
            {{ csrf_field() }}
          <div class="box-body">
            <br />
            <div class="form-group">
              ...
              <div class="col-sm-10">
              <input type="text" class="form-control" name="nik" required value="{{$data->nik}}" onkeypress="return hanyaAngka(event)">
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" name="pekerjaan_ayah" value="{{$data->pekerjaan_ayah}}"  required>
                </div>
            </div>
            <div class="form-group">
