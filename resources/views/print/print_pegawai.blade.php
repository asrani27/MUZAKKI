...
<hr />
<p class="auto-style1"><strong>Laporan Data Pegawai</strong></p>
<table align="left" cellpadding="3" cellspacing="0" class="auto-style2" style="width: 100%">
	...
	<tr>
		...
		<td class="auto-style7">{{$item->nik}}</td>
		<td class="auto-style7">{{$item->nama}}</td>
		<td class="auto-style7">{{$item->jkel}}</td>
		<td class="auto-style7">{{$item->jabatan->nama}}</td>
		<td class="auto-style7">{{$item->telp}}</td>
	</tr>
	@endforeach
