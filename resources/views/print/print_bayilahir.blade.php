...
<table align="left" cellpadding="3" cellspacing="0" class="auto-style2" style="width: 100%">
	...
	<tr>
		...
		<td class="auto-style7">{{$item->hari}}</td>
		<td class="auto-style7">{{$item->tanggal}}</td>
		<td class="auto-style7">{{$item->waktu}}</td>
		<td class="auto-style7">{{$item->tempat}}</td>
		<td class="auto-style7">{{$item->jkel}}</td>
		<td class="auto-style7">{{$item->nama_ibu}}</td>
	</tr>
	@endforeach
