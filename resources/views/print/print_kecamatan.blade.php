...
<hr />
<p class="auto-style1"><strong>Laporan Data Pegawai Di Kecamatan</strong></p>
<table align="left" cellpadding="3" cellspacing="0" class="auto-style2" style="width: 100%">
	<tr>
		...
		<td class="auto-style3"><strong>Nama Pegawai</strong></td>
	...
	<tr>
		...
		<td class="auto-style7">{{$item->kecamatan->nama}}</td>
