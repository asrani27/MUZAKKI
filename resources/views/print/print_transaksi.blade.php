...
<hr />
<p class="auto-style1"><strong>Laporan Data Transaksi</strong></p>
<table align="left" cellpadding="3" cellspacing="0" class="auto-style2" style="width: 100%">
	<tr>
		...
		<td class="auto-style3"><strong>Petugas</strong></td>
		<td class="auto-style3"><strong>Jenis</strong></td>
		<td class="auto-style3"><strong>Alat</strong></td>
	</tr>
	<?php
	$no =1;
	?>
	...
	<tr>
		...
		<td class="auto-style7">{{$item->no_kw}}</td>
		<td class="auto-style7">{{$item->peserta->nama_peserta}}</td>
		<td class="auto-style7">{{$item->pegawai->nama}}</td>
		<td class="auto-style7">{{$item->jenis->nama}}</td>
		<td class="auto-style7">{{$item->alat->nama}}</td>
	</tr>
	@endforeach
